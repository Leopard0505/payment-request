...
/* harmony import */ var _payment_request_method_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./payment-request-method.js */ "./src/js/payment-request-method.js");
...
stripeButton.addEventListener('click', function () {
  ...
  var payment = new _payment_request_method_js__WEBPACK_IMPORTED_MODULE_0__["default"](params, displayItems);
  payment.pay();
});

/***/ }),

/***/ "./src/js/payment-request-method.js":
/*!******************************************!*\
  !*** ./src/js/payment-request-method.js ***!
  \******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PaymentRequestMethod; });
/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/style.css */ "./src/css/style.css");
/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_css_style_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var stripe_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! stripe-client */ "./node_modules/stripe-client/index.js");
/* harmony import */ var stripe_client__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(stripe_client__WEBPACK_IMPORTED_MODULE_1__);
...
function () {
   ...
   */
  function PaymentRequestMethod(params, displayItems) {
    _classCallCheck(this, PaymentRequestMethod);

    if (!displayItems) throw new Error('found not displayItems');
    var TypeErrorMessage = this.validateAmount(displayItems);
    if (TypeErrorMessage) throw new TypeError(TypeErrorMessage); // params

    this.url = params.url ? params.url : '/pay';
    this.currency = params.currency ? params.currency : 'JPY'; // Stripe PK Key

    this.stripe_pk_key = params.stripe_pk_key ? params.stripe_pk_key : null;
    this.stripe = new stripe_client__WEBPACK_IMPORTED_MODULE_1___default.a(this.stripe_pk_key);
    this.displayItems = displayItems; // Supported payment methods

    this.supportedInstruments = [{
      supportedMethods: ['basic-card'],
      data: {
        supportedNetworks: ['visa', 'mastercard'],
        // 'amex','discover', 'diners', 'jcb', 'unionpay'
    ...
    this.details = {
      ...
      shippingOptions: this.shippingOptions // Options
  ...
  _createClass(PaymentRequestMethod, [{
    key: "calculation",
    value: function calculation(items) {
      var total = {
        label: '合計',
        amount: {
    ...
    key: "validateAmount",
    value: function validateAmount(items) {
    ...
    key: "isPaymentRequest",
    value: function isPaymentRequest() {
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee() {
        ...
        var request, result, body, information, card, token, status, response;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                request.addEventListener('shippingaddresschange', function (ev) {
                  ev.updateWith(function (details) {
                    // let shippingOption = {
                    //   id: '',
                    //   label: '',
                ...
                request.addEventListener('shippingoptionchange', function (ev) {
                  ...
                  var prInstance = event.target; // Step 2: Get the ID of the selected shipping option.

                  var selectedId = prInstance.shippingOption; // Step 3: Mark selected option

                  var selectedOption = null;

                  _this.shippingOptions.forEach(function (option) {
                  ...
                  var newShippingOptions = _this.displayItems.filter(function (item) {
                    return !item.id;
                  });
                  ...
                  ev.updateWith({
                    ...
                    total: _this.calculation(newShippingOptions),
                    shippingOptions: _this.shippingOptions
                  });
